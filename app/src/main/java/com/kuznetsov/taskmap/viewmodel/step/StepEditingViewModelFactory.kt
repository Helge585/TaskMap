...
class StepEditingViewModelFactory(private val stepDao: StepDao,
                                   private val stepId: Long): ViewModelProvider.Factory {

    override fun <T: ViewModel> create(modelClass: Class<T>): T {
        if (modelClass.isAssignableFrom(StepEditingViewModel::class.java)) {
            return StepEditingViewModel(stepDao, stepId) as T
        }
